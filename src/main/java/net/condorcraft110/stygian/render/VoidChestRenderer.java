...
{
	private final ResourceLocation texture = new ResourceLocation("stygian", "textures/models/blocks/voidChest.png");
	private final ModelChest model = new ModelChest();
	
	public void renderTileEntityAt(TileEntity entity, double x, double y, double z, float var8) 
	{
		if(entity instanceof TileEntityVoidChest)
		{
			TileEntityVoidChest tevc = (TileEntityVoidChest)entity;
			bindTexture(texture);
			GL11.glPushMatrix();
